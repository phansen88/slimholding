...
export default function Example() {
  ...
  return (
    <div className="shadow overflow-hidden sm:px-6 md:px-8 bg-white border-b border-gray-200 sm:rounded-lg">
      ...
      <section aria-labelledby="products-heading" className="pt-6 pb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-x-8 gap-y-10">
          ...
          {/* Product grid */}
          <div className="grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 lg:col-span-3 lg:gap-x-8">
