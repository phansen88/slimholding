...
const userNavigation = [
  ...
  { title: 'Settings', uid: 'def', href: '#' },
  { title: 'Sign out', uid: 'ghi', href: '#' },
];
                  ...
                  {navigation.map((item) => (
                    <NavLink
                      ...
                      className={({ isActive }) =>
                        classNames(
                          isActive
                            ? 'bg-indigo-800 text-white underline'
                    ...
                    >
                      <DynamicHeroIcon
                        icon={item.icon}
                        iconstyles="mr-4 flex-shrink-0 h-6 w-6 text-indigo-300"
                      />
                      {item.title}
                    </NavLink>
                  ))}
                ...
                !item.children ? (
                  <div key={item.uid}>
                    ...
                    >
                      <DynamicHeroIcon
                        icon={item.icon}
                        iconstyles={`mr-3 flex-shrink-0 h-6 w-6 ${
                          item.current
                            ? 'text-indigo-300'
                    ...
                    {({ open }) => (
                      <>
                        ...
                        >
                          <DynamicHeroIcon
                            icon={item.icon}
                            iconstyles="mr-3 flex-shrink-0 h-6 w-6 text-indigo-300 group-hover:text-indigo-400"
                          />
                          <span className="flex-1">{item.title}</span>
                          <svg
                            className={classNames(
                          ...
                          {item.children.map((subItem) => (
                            <NavLink
                              ...
                              className={({ isActive }) =>
                                classNames(
                                  isActive ? 'underline' : '',
                                  'group w-full flex items-center pl-11 pr-2 py-2 text-sm font-medium  text-indigo-200 rounded-md hover:text-white hover:bg-indigo-800'
                                )
                              }
                              end
                            >
